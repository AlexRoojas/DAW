...
//---------------------------------------------------
//------------- Tabla 2 ----------------------------------------------------------
function tabla2(titulo,id,donde,datos,complementos){ //{borrar:true, Subtotal:{c1:,c2}}
// Crear <table> y sus dos atributos
	...
	//if(complementos.subtotal){
            if(complementos.subtotal!==undefined){
		cabecera = document.createElement('th');
	...
	//for (i=1; i<=nfilas ; i++)
	{
		...
		for (j=1; j<ncolumnas ; j++)
			...
			tbody.rows[clave].cells[ncolumnas].innerHTML =
                                                    parseFloat(tbody.rows[clave].cells[complementos.subtotal.c1].innerHTML)
						    *parseInt(tbody.rows[clave].cells[complementos.subtotal.c2].innerHTML);
