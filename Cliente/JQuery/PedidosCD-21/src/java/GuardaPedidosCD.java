...
public class GuardaPedidosCD extends HttpServlet {

//HttpServletRequest request;
private String userName="pedidosCD";
private String password="pedidos";
private String url="jdbc:mysql://localhost:3306/pedidoscd";
      ...
      // Paso 4: Crear la sentencias SQL, a partir de los parametros recibidos
       ...
       while(lineas.hasNext()){
         ...
         //  Iterator columnas = detalle.keys();
          ...
          /*  sqlStr="INSERT INTO detallepedidos VALUES('"+
                    titulo+"', '"+autor+"', '"+precio+"', '"+
                    cantidad+"', '"+pedido.get("codigo")+"')";*/
       ...
       // out.println( "pedido n�  "+ pedido.get("codigo")+" Guardado correctamente");
        out.println( json.toString());
            ...
            try{
                ...
                Logger.getLogger(GuardaPedidosCD.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
