...
<html lang="es">
  <head>
    ...
    <title>Taller AR Customs | Partes Mecánico</title>
...
<body>
    ...
    <h4 class="text-center my-5"><span>${usuario.nombreusu}</span>, aquí están los partes.</h4>
     <a href="vercreaParte" title="Página para crear el parte"><button class="offset-3 offset-md-9 col-md-2 btnDet mb-3 mr-3 btn-indigo">Crear nueva Factura</button></a>
    <div class="col-10 offset-1 d-flex justify-content-center ">
       ...
       <div class="container-fluid">
        ...
        <div class="accordion" id="accordionExample">
	       ...
	       <c:forEach var="parte" items="${listaPartes}" varStatus="indice">
	       		<input type="hidden" name="codParte" value="${parte.codParte }">
	       		<div class="accordion-item">
				    ...
				    <h2 class="accordion-header" id="headingOne">
				      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${indice.index}" aria-expanded="true" aria-controls="collapseOne">
				        <p class="fw-bold">Código Parte:<span class="fw-normal"> ${parte.codParte}</span></p>
				      </button>
				    </h2>
				    ...
				    <div id="collapse${indice.index}" class="accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
				      <div class="accordion-body">
				            ...
				            <div class="col-md-2 m-2">
				              <p class="fw-bold">Código cita: <span class="fw-normal"> ${parte.codcitaParte}</span></p>
				            </div>
				            <div class="col-md-2  m-2">
				              <p class="fw-bold">Matrícula: <span class="fw-normal"> ${parte.matricParte}</span></p>
				            </div>
				            <div class="col-md-2  m-2">
				              <p class="fw-bold">Código mecánico: <span class="fw-normal"> ${parte.codmecParte}</span></p>
				            </div>
				            <div class="col-md-2  m-2">
				              <p class="fw-bold">Productos : <span class="fw-normal"> ${parte.productosParte}</span></p>
				            </div>
				            <div class="col-md-2  m-2">
				              <p class="fw-bold">Costes Total: <span class="fw-normal"> ${parte.costesTotal} $</span></p>
				            </div> 
				            <div class="col-md-2  m-2">
				              <p class="fw-bold">Fecha creación: <span class="fw-normal"> ${parte.fechaParte}</span></p>
				            </div>
				            
				            <div class="col-md-3 m-2">
				              <span id="tipCit" class="fw-bold mb-2">Estado Actual : </span class="fw-normal mb-2">${parte.estadoParte}</span></span>
				              <form action="actualizaParte">
				              <input type="hidden" name="codiguito" value="${parte.codParte}">
