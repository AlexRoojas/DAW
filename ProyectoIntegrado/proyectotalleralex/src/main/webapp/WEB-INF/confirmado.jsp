     ...
     <div class="col-10 offset-1 d-flex justify-content-center border border-warning border-3 rounded-3 bordeColor">
       <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center my-5 flex-column align-content-center">
          ...
          <div class="col-md-3">
            <button type="button" class="btnCompra comprar"><h5>Comprar</h5></button>
          </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                  <button type="button" class="btn btn-primary" data-bs-dismiss="modal"><a href="cargaFactura" class="text-decoration-none sinDeco cerSes" title="Enlace para ver la última factura">Ver Factura</a></button>
                </div>
              </div>
            </div>
          </div>
