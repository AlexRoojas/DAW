...
<head>
    ...
    <script>
	    $(document).ready( function () {
	    	...
	    	var objFact = JSON.parse($("#jsonprodCompleto").val());
	    	
	    	var claveObjOrd = Object.keys(objFact);
	...
	<div class="container-fluid p-0">
     ...
     <div class="col-10 offset-1 ">
      <div class="row d-flex justify-content-center my-5">
        ...
        <div class="col">
          <a href="verAdminFacts"><button class="btnAdmin mb-3 mr-3 activo"> <h5>Facturas</h5></button></a>
        </div>
      </div>
     </div>
     <!-- FIN CAJA PRINCIPAL-->
