...
public class FileSystemStorageService implements StorageService{
	...
	@Override
	public String store2(String nombre, MultipartFile file, String nombreFigura) {
		    String filename = StringUtils.cleanPath(nombre);
	        String extension = StringUtils.getFilenameExtension(filename);
	        String storedFilename =nombreFigura;
	        try {
	            if (file.isEmpty()) {
    ...
    @Override
    public String store(MultipartFile file, String nombreFigura) {
