<%-- 
    Document   : index
    Created on : 5 feb. 2022, 16:54:34
    Author     : kete
--%>
...
<f:view>
    <html>
        ...
        <body>
            <center><h2><h:outputText value="#{txt.anuncio}"/></h2></center>
            
            <h:form>
                
            <p><h:outputText value="#{txt.nombre}"/> <h:inputText value="#{datos.nombre}"/></p>
            ...
            <h:inputTextarea value="#{datos.razon}"/></p>
