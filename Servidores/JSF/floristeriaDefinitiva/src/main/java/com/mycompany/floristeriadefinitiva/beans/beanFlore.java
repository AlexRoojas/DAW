...
public class beanFlore {
    ...
    @ManagedProperty("#{beanRespal}")
    private beanRespaldo miUsuarioo;
    ...
    public beanRespaldo getMiUsuarioo() {
        return miUsuarioo;
    }

    public void setMiUsuarioo(beanRespaldo miUsuarioo) {
        this.miUsuarioo = miUsuarioo;
    }
    ...
    public void alcarro(){
        ...
        String dni = miUsuarioo.getMiUsu().getDniusuario();
    ...
    public boolean pintar(){
        if(miUsuarioo.getMiUsu().getPassusuario().equals("1")){
            return true;
        }else{
            return false;
        }
