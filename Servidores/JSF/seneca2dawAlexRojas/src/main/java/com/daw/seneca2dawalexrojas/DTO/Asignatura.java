...
@NamedQueries({
    ...
    @NamedQuery(name = "Asignatura.buscaCurso", query = "SELECT a.idCurso DISCTINCT FROM Asignatura a WHERE a.codProfesor = :codProfesor"),
    @NamedQuery(name = "Asignatura.buscaAsig", query = "SELECT a DISCTINCT FROM Asignatura a WHERE a.idCurso = :idCurso AND a.codProfesor = :codProfesor")
})
public class Asignatura implements Serializable {
    ...
    public String toString() {
        return "com.daw.seneca2dawalexrojas.DTO.Asignatura[ idAsig=" + idAsig + " ]";
    }
