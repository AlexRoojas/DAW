...
@NamedQueries({
    ...
    @NamedQuery(name = "Profesor.findByUsuPass", query = "SELECT p FROM Profesor p WHERE p.usuProfesor = :usuProfesor AND p.passProfesor = :passProfesor")
})
public class Profesor implements Serializable {
    ...
    public String toString() {
        return "com.daw.seneca2dawalexrojas.DTO.Profesor[ codProfesor=" + codProfesor + " ]";
    }
