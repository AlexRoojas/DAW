...
public class ProfesorJpaController implements Serializable {
    ...
    public List buscarProfe(String usuario,String password){
        EntityManager em = getEntityManager();
        TypedQuery q = em.createNamedQuery("Profesor.findByUsuPass", Profesor.class);
        q.setParameter("usuProfesor", usuario);
        q.setParameter("passProfesor", password);
        return q.getResultList();
    }
