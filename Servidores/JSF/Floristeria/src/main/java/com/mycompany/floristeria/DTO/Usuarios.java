...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.findByUsuPass", query = "SELECT u FROM Usuarios u WHERE u.nombreusuario = :nombreusuario AND u.passusuario = :passusuario")
})
public class Usuarios implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.floristeria.DTO.Usuarios[ dniusuario=" + dniusuario + " ]";
    }
