 ...
 */
package com.daw.subidaarchivo.DAO;

import com.daw.subidaarchivo.DAO.exceptions.NonexistentEntityException;
import com.daw.subidaarchivo.DAO.exceptions.PreexistingEntityException;
...
public class VistadetalleJpaController implements Serializable {
    ...
    public List buscarDetalle(String c){
        EntityManager em = getEntityManager();
        TypedQuery q = em.createNamedQuery("Vistadetalle.findByDniusuario", Vistadetalle.class);
        q.setParameter("dniusuario", c);
        return q.getResultList();
    }
}
