...
public class verCesta extends HttpServlet{
	...
	public void proceso (HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException {
		...
		for (int codArticulo : carrito.keySet()) {
			...
			out.println("<input type='submit' name='opcion' value='sumar'>");
			out.println("<input type='submit' name='opcion' value='quitar'>");
			out.println("<input type='submit' name='opcion' value='borrar'>");
			out.println("<input type='hidden' name='artSel2' value='"+codArticulo+"'>");
			
			out.println("</li>");
		}
		
		out.println("</gestionaCesta>");
		out.println("</ul>");
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException{
        ...
        RequestDispatcher rd = sc.getRequestDispatcher("/gestionaCesta");
