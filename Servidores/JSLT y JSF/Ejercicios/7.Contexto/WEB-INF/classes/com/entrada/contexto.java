...
public class contexto extends HttpServlet{
	...
	public void proceso (HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException
	{
		...
		out.println("<style>");
		out.println("body{text-align:center; background: url(");   
		
					if((mes==3&&dia>20) || mes==4 || mes==5 ||(mes==6&&dia<21)){
						out.println(contexto.getInitParameter("imgPrim"));
					}else if((mes==6&&dia>20) || mes==7 || mes==8 ||(mes==9&&dia<21)){
						
						out.println(contexto.getInitParameter("imgVer"));
					}else if((mes==9&&dia>20)|| mes==10 || mes==11 ||(mes==12&&dia<21)){
						
						out.println(contexto.getInitParameter("imgOto"));
					}else{
						
						out.println(contexto.getInitParameter("imgInv"));
					}
					
					
					out.println(") no-repeat; background-size:cover;}");
