...
import com.daw.mantenimientopeliculasjv.DAO.exceptions.PreexistingEntityException;
import com.daw.mantenimientopeliculasjv.DTO.Genero;
...
public class GeneroJpaController implements Serializable {
    ...
    public void create(Genero genero) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findGenero(genero.getCodGen()) != null) {
