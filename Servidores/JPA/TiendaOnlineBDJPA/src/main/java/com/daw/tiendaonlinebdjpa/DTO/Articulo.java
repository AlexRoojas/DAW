...
@NamedQueries({
    ...
    @NamedQuery(name = "Articulo.findAllCategorias", query = "SELECT DISTINCT a.categoria FROM Articulo a")
})
public class Articulo implements Serializable {
    ...
    public String toString() {
        return  codArticulo + ", " + denominacion + ", " + categoria + ", " + precio + ", " + existencias + ", " + codproveedor + ", " + imagen;
    }
