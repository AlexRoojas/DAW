 ...
 * @author kete
 */
public class opCesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        DetallePK detallePk = (DetallePK)request.getAttribute("DetallePk");
        
    // Horror   Detalle detalleEx = ctrlDetalle.findDetalle(miDetalle.getDetallePK());
        
        Detalle detalleEx = ctrlDetalle.findDetalle(detallePk);
        
        
        String op = request.getParameter("op");
        
        if(op!=null){
           int cArt=detallePk.getCodArticulo();
            ...
            }else{if(op.equalsIgnoreCase("menos")){
                detalleEx.setCantidad(detalleEx.getCantidad()-1);
                int nuevaExistencias = miArt.getExistencias()+1;
                miArt.setExistencias(nuevaExistencias);
                try {
