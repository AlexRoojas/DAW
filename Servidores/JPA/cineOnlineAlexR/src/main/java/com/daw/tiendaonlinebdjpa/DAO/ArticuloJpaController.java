...
public class ArticuloJpaController implements Serializable {
    ...
    public void compraArt(int codArt, int cantidad){
        EntityManager em = getEntityManager();
        
        em.getTransaction().begin();
        
        Query q = em.createNativeQuery("update articulo set existencias=existencias-"+cantidad+" where cod_articulo="+codArt);
    ...
    public List<String> getAllCategorias(){
        ...
        TypedQuery q = em.createNamedQuery("Articulo.findAllCategorias", Articulo.class);
